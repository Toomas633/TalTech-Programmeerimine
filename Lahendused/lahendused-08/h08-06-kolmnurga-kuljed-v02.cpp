...
// Protseduur, mis esitab kasutajale küsimuse ja loeb käsurealt sisse ühe
// punkti koordinaadid
void loe_punkt(double& x, double& y, string nimi) {
	x = loe_reaalarv("Sisesta punkti " + nimi + " x-koordinaat");
	y = loe_reaalarv("Sisesta punkti " + nimi + " y-koordinaat");
}
